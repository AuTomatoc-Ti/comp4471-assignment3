...
def discriminator_loss(logits_real, logits_fake):
    ...
    real_labels = torch.ones(N, device=logits_real.device, dtype=logits_real.dtype)
    fake_labels = torch.zeros(logits_fake.shape[0], device=logits_fake.device, dtype=logits_fake.dtype)
...
def generator_loss(logits_fake):
    ...
    fake_labels = torch.ones(N, device=logits_fake.device, dtype=logits_fake.dtype)
